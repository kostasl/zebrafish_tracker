...
class trackerState
{
 public:
     ...
     ///// Option Flags //
      ...
      float fishnet_classifier_thres  = 0.95f; //L1 neuron Activity Threshold Sets the Pattern Selectivity and sparseness of L1 output
      ...
      int gFishBoundBoxSize               = 80; /// 24/ pixel width/radius of bounding Box When Isolating the fish's head From the image
