...
int main(int argc, char *argv[])
{
   ...
   std::cout << "Csv Output Dir is " << outDir.toStdString()  << "\n " <<std::endl;
    ...
    //OPENCV 3
    // BENA!!! *************************
    //Remember Syntax has changed from OpenCV 2.9.X. This will work in OpenCV 3.0.0:
...
unsigned int getBGModelVideo(cv::Mat& fgMask,MainWindow& window_main,QString videoFilename,QString outFileCSV,unsigned int startFrameCount) {
{
