...
boutInterval = 0.100
captureDistance = 0.25 ##mm
CaptureAimingAngle= 0 ##Larva's Initial Aiming angle prior to Prey Moving 
 
print(aimDeflectionAngle(preyspeed,boutInterval,captureDistance,CaptureAimingAngle))
print(aimDeflectionAngle(preyspeed,boutInterval,captureDistance*2,CaptureAimingAngle))
```
