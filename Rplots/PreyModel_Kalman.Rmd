...
aimDeflectionAngle<- function(preyspeed,boutInterval,captureDistance,CaptureAimingAngle) return(preyspeed*boutInterval/((captureDistance^2)*cos(CaptureAimingAngle*pi/180))*(180/pi));

preyspeed = 0.5 ##Mm/sec
boutInterval = 0.200
captureDistanceNear = 0.25 ##mm
captureDistanceFar = 0.4 ##mm
CaptureAimingAngle= 0 ##Larva's Initial Aiming angle prior to Prey Moving 

print(paste0("Prey at small distance ",captureDistanceNear,"mm : ",aimDeflectionAngle(preyspeed,boutInterval,captureDistanceNear,CaptureAimingAngle) ) )
print(paste0("Prey large distance ",captureDistanceFar,"mm : ", aimDeflectionAngle(preyspeed,boutInterval,captureDistanceFar,CaptureAimingAngle) ) )
