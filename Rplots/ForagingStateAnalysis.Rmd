...
getLogLogDistributions_MSDAndDispersion <-function(datDispersion,strG,addPlot=FALSE,powerLawRange = 100)
{
    ...
    xbreaks_Dispersion <-seq(0,11,0.5)
    ...
    lLinModel_GE$logDistribution <-log10(100*h_MSD_GE$counts/sum(h_MSD_GE$counts) )
    ...
    lLinModel_GE$logDistribution <-log10(100*h_Dispersion_GE$counts/sum(h_Dispersion_GE$counts) )
...
plotLogLogDistribution_MSD <- function(lLinModel_GE,addPlot=FALSE)
{
    ...
    if (!addPlot) 
    {
      plot(lLinModel_GE$xtickMSD,lLinModel_GE$logDistribution,
    ...
    {
        points(lLinModel_GE$xtickMSD,lLinModel_GE$logDistribution,
         main=paste(" Log-Log percentage of MSD " ),
         xlab="log_10 Mean Squared Displacent (mm)", col=colourDataScheme[strG][[1]], pch=16, ylab="log N(l) %")
    }
    ##Plot Linear Model
...
plotLogLogDistribution_MSD <- function(lLinModel_GE,addPlot=FALSE)
{
    ...
    if (!addPlot) 
    {
      plot(lLinModel_GE$xtickDispersion,lLinModel_GE$logDistribution,
         main=paste(" Log-Log distribution of Dispersion "),
         xlab="log_10 Dispersion (mm)", col=colourDataScheme[strG][[1]], pch=16,
         xlim=c(min(lLinModel_GE$xtickDispersion),max(lLinModel_GE$xtickDispersion)*1.01),
         ylim=c(-4,3),
         ylab="log N(l) %",xaxt="n" )
    ...
    {
        points(lLinModel_GE$xtickDispersion,lLinModel_GE$logDistribution,
         main=paste(" Log-Log percentage of Dispersion " ),
...
plotDispersionPerTime <- function(lModelwithDispersion,addPlot=FALSE)
{
  ...
  for (i in 1:NROW(lModelwithDispersion))
  {
    ...
    {
      vMSD[i] <- lModelwithDispersion[[i]]$meanDispersion
  ...
  if (!addPlot)
  {
    plot(vTimeWindow[idxOrder],vDispersionD[idxOrder],xlim=xLim,ylim=c(0,100),
