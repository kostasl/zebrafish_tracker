...
getLogLogDistributions_MSDAndDispersion <-function(datDispersion,strG,addPlot=FALSE,powerLawRange = 100)
{
    ...
    lLinModel_GE$countPooledDispersionPerLarva <- tapply(datGroupDispersion[ ,"Dispersion"],datGroupDispersion[ ,"expID"],NROW)
...
vtimeWindows <- c(vsmallTimeWindows,80,90,95,98,100,120,180)# c(1,2,4) # vsmallTimeWindows##c(4,10,20,80,200,260,360)
...
```{r mean-squared-distance distribution over larva , fig.show="hold",fig.cap="Group Mean squared distance over time for LF spontaneous shows distinctive quick growth", out.width="100%", echo=FALSE, cache=FALSE}

##Get Distribution of MSD and Mean MSD for each time integration window 
##load Precalc Results
  hist(lMSDSummaryData[["NE"]]$meanMSDPerLarva, col=colourDataScheme["NE"])
  hist(lMSDSummaryData[["LE"]]$meanMSDPerLarva, col=colourDataScheme["LE"])
