...
plotBoundedFreePath <- function(datBoundedTrack,strG,addPlot=FALSE)  
{
  ...
  ### Analyse Free Paths - Look at distribution Run lengths between turns For Each Domain Size
  ...
  saveRDS(ldatFreePathD , file=paste0(strDataExportDir,"/stat_BOUT_freePathPerDomainSize.rds") )
