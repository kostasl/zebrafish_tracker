...
```{r,merge maxl arval-dispersion onto dispersion data events, echo=FALSE,cache=TRUE}
...
mergeMaxLarvalDispersionPerLarvaOntoDispersion <- function(datDispersion,datExpPairs)
{
  ...
  datDispesionMax_Pairs <-  data.frame.rbind(
                                           data.frame.cbind(
...
Separating Spontaneous from Evoked Conditions we see :
...
hist(datDispersion[datDispersion$groupID %in% c('LE'), ]$max_larval_Dispersion, breaks=100,main="LF Spont ", xlab="Dispersion  (max per larva)")
