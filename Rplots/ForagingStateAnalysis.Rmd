...
plotMSDPerIntegrationTime <- function(ldatDispersion,strG,lLinModel)
{
  ...
  {
    print(tt)
    lLinModel[[strG]][[as.character(tt)]] = plotLogLogMSD(ldatDispersion[[tt]],strG,bAddPlot)
    bAddPlot <- TRUE
  }
...
vtimeWindows <- c(4,10,20,80,200,260,360)
##Load All
...
saveRDS(lLinModel,paste0(strDataExportDir,"MSDPerPathDurationSummaryResults2.rds"))
...
saveRDS(lMSDStat,paste0(strDataExportDir,"MSDPerPathLengthSummaryResults.rds"))
  ...
  ##Combined
   ...
   text(x=xtick,  par("usr")[3], 
     labels = colnames(lvmeanPathLengthPerMSD[[strG]]), srt = 25, pos = 2, xpd = TRUE)
