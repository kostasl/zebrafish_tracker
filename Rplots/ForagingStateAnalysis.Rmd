...
plotClusteredDispersionHist <- function(lmcmcRes,vDispersion,clustCol)
{
  ...
  hist(vDispersion[lmcmcRes$clustID == 1],xlim=c(0,10),ylim=c(0,max(list_histo$counts)), breaks=breaksSlots,col=clustCol[1],main=paste("Clustered densities", lmcmcRes$groupID ),xlab = "Dispersion (mm)",add=TRUE)
  hist(vDispersion[lmcmcRes$clustID == 2],xlim=c(0,10), breaks=breaksSlots,col=clustCol[2],main=groupID,xlab = NA,add=TRUE)  
