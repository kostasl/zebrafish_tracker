...
plotMSDPerTime <- function(lModelwithMSD,addPlot=FALSE)
{
  ...
  if (!addPlot)
  {
    plot(vTimeWindow[idxOrder],vMSD[idxOrder],xlim=c(0,60),ylim=c(0,70),
    ...
    points(vTimeWindow[idxOrder],vMSD[idxOrder],xlim=c(0,60),ylim=c(0,70),
           col=colourDataScheme[[lModelwithMSD[[1]]$groupID]],
           pch=pointTypeScheme[[lModelwithMSD[[1]]$groupID]])
  
  lines(vTimeWindow[idxOrder],vMSD[idxOrder],xlim=c(0,60),ylim=c(0,70), col=colourDataScheme[[lModelwithMSD[[1]]$groupID]],
        pch=pointTypeScheme[[lModelwithMSD[[1]]$groupID]])
}
