...
## Identify diffusion type using *Hurst exponents*
...
Overall I find that the generalized Hurst exponent scales in power-law fashion against time-interval - This is evidence of  *long-range dependence (LRD)*.
...
My results show that In the small timescales <15 sec the exponent indicates persistent behaviour, which is indicative of *Balistic* motion (H>1). These are stronger in LE indicating the ontogeny of intermittent search strategies, through balistic relocations. 
This is a result of experience because in controls the coefficients appear identical in the respective test conditions.
