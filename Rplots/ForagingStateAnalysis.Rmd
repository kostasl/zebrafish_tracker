...
write.jagsfile(results.All, file=paste0(strDataExportDir,'jagsModelTest_NBMixGroupclustDispersion_All.txt') )
save(list=c("results.All","datSubDispersion"),file=paste0(strDataExportDir,'jagsModelTestResults_NBMixGroupclustDispersion_All.RData') )
...
#which((datSubDispersion$frameRow - datHEventDispersion$frameRow) ==  min(abs(datSubDispersion$frameRow - datHEventDispersion$frameRow),na.rm = TRUE) )
...
datHEventDispersion[datHEventDispersion$frameRow %in% datSubDispersion$frameRow, ]
