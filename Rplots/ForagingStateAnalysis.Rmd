...
pairedTrajPalette <- col2hex(col2rgb(brewer.pal(8,"Paired"),alpha = 1))

## Plot function for scatter plot of colour coded larval trajectories, separated into explore and exploit vectors 
### 
plotExploreExploitTrajectories <- function(groupID,datGroupExploreTraj,datGroupExploitTraj, datExplorationHuntEvents, datExploitationHuntEvents, thin=3)
{
  ...
  for (e in vexpID)
  {
      ...
      # Exploration
      datSpotHunts <- datExplorationHuntEvents[datExplorationHuntEvents$expID == as.character( e)  & !is.na(datExplorationHuntEvents$expID), ] 
      points(datSpotHunts$posX, datSpotHunts$posY, col=pairedTrajPalette[2], cex=1.2, pch=17)
      ## Exploitation
      datSpotHunts <- datExploitationHuntEvents[datExploitationHuntEvents$expID == as.character( e)  & !is.na(datExploitationHuntEvents$expID), ] 
      points(datSpotHunts$posX, datSpotHunts$posY,col=pairedTrajPalette[6], cex=1.2,pch=15)
...
##
plotGlobalNormDispersionTrajectories <- function(groupID, datAllFrames, datDispersion, datHEventDispersion,TH_DISP = 0.2)
{ 
  ...
  plotExploreExploitTrajectories(groupID,datGroupExploreTraj,datGroupExploitTraj, datExplorationHuntEvents, datExploitationHuntEvents)
...
##
plotExpNormDispersionTrajectories <- function(groupID, datAllFrames, datDispersion,datHEventDispersion, TH_DISP = 0.2)
{
...
## Check LF
hist(datHEventDispersion[datHEventDispersion$groupID=='LL', ]$Dispersion,breaks=100,main="LF",xlab="Dispersion ",xlim=c(0,10))

## Check NF
hist(datHEventDispersion[datHEventDispersion$groupID=='NL', ]$Dispersion,breaks=100,main="NF",xlab="Dispersion",xlim=c(0,10))

## Check DF
hist(datHEventDispersion[datHEventDispersion$groupID=='DL', ]$Dispersion,breaks=100,main="DF",xlab="Dispersion",xlim=c(0,10))
...
plotGlobalNormDispersionTrajectories('LL', datAllFrames, datDispersion, datHEventDispersion,   thres_dispersion_class )
...
plotGlobalNormDispersionTrajectories('NL',datAllFrames,datDispersion,datHEventDispersion, thres_dispersion_class )
...
plotGlobalNormDispersionTrajectories('DL',datAllFrames,datDispersion,datHEventDispersion, 0.2)
```

#### Spontaneous conditions
### LF - Spontaneous Trajectories
```{r,  global_norm-trajectories-LE, fig.show="hold", out.width="50%", echo=FALSE, results='hide' ,cache=TRUE, autodep=TRUE}
...
```{r, global_norm-trajectories-NE, fig.show="hold", out.width="50%", echo=FALSE, results='hide', cache=TRUE, autodep=TRUE}

plotGlobalNormDispersionTrajectories('NE',datAllFrames,datDispersion ,datHEventDispersion, thres_dispersion_class )

```

#### DF - Spontaneous Trajectories 
```{r, global_norm-trajectories-DE, fig.show="hold", out.width="50%", echo=FALSE, results='hide', cache=TRUE, autodep=TRUE}

plotGlobalNormDispersionTrajectories('DE',datAllFrames,datDispersion,datHEventDispersion , 0.2)
...
#### LF - Evoked Trajectories
```{r,  exp_norm-trajectories-LL, fig.show="hold", out.width="50%", echo=FALSE, results='hide' , cache=TRUE, autodep=TRUE}

plotExpNormDispersionTrajectories('LL',datAllFrames,datDispersion ,datHEventDispersion,  thres_dispersion_class )

```

#### NF - Evoked Trajectories 
```{r, exp_norm-trajectories-NL, fig.show="hold", out.width="50%", echo=FALSE, results='hide',cache=TRUE, autodep=TRUE}

plotExpNormDispersionTrajectories('NL',datAllFrames,datDispersion ,datHEventDispersion, thres_dispersion_class )


```

#### DF - Evoked Trajectories 
```{r, exp_norm-trajectories-DL, fig.show="hold", out.width="50%", echo=FALSE, results='hide', cache=TRUE, autodep=TRUE}

plotExpNormDispersionTrajectories('DL',datAllFrames,datDispersion ,datHEventDispersion, 0.2)

```

#### Spontaneous conditions
### LF - Spontaneous Trajectories
```{r,  exp_norm-trajectories-LE, fig.show="hold", out.width="50%", echo=FALSE, results='hide', cache=TRUE, autodep=TRUE }
...
#### NF - Spontaneous Trajectories 
```{r, exp_norm-trajectories-NE, fig.show="hold", out.width="50%", echo=FALSE, results='hide', cache=TRUE, autodep=TRUE}

plotExpNormDispersionTrajectories('NE',datAllFrames,datDispersion , datHEventDispersion,thres_dispersion_class )

```

#### DF - Spontaneous Trajectories 
```{r, exp_norm-trajectories-DE, fig.show="hold", out.width="50%", echo=FALSE, results='hide', cache=TRUE, autodep=TRUE}

plotExpNormDispersionTrajectories('DE',datAllFrames,datDispersion,datHEventDispersion , 0.2)
