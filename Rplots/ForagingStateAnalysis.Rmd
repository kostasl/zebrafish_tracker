...
rm(ldatDispersion)
ldatDispersion <- list()
vtimeWindows <- c(2,4,6,8,10,20,40)
...
plotMSDPerTime(lLinModel_NE)
plotMSDPerTime(lLinModel_NL,TRUE)
plotMSDPerTime(lLinModel_LE,TRUE)
plotMSDPerTime(lLinModel_LL,TRUE)
plotMSDPerTime(lLinModel_DE,TRUE)
plotMSDPerTime(lLinModel_DL,TRUE)
