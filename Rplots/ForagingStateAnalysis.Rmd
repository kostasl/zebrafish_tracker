...
plotGlobalNormDispersionTrajectories <- function(groupID, datAllFrames, datDispersion, TH_DISP = 0.2)
{
  ...
  datExplorationHuntEvents <- datGroupExploreTraj[datGroupExploreTraj$expID == datHuntLabelledEventsSBMerged_fixed$expID &
                      datGroupExploreTraj$eventID == datHuntLabelledEventsSBMerged_fixed$eventID &
                        datGroupExploreTraj$frameN == datHuntLabelledEventsSBMerged_fixed$startFrame,
                      ]  
##Add Hunt Events on Map  
 points(datHEventDispersion[datHEventDispersion$Dispersion/AllRange[2] >= TH_DISP,]$posX,datHEventDispersion[datHEventDispersion$Dispersion/AllRange[2] >= TH_DISP,]$posY,col="blue")
 points(datHEventDispersion[datHEventDispersion$Dispersion/AllRange[2] < TH_DISP,]$posX,datHEventDispersion[datHEventDispersion$Dispersion/AllRange[2] < TH_DISP,]$posY,col="red")
...
datHEventDispersion <- readRDS(datHEventDispersion,file=paste0(strDataExportDir,"/huntEvent_mergedwith_Dispersion",tsec_timeWindow,"sec.rds") )
...
## Check LF
hist(datHEventDispersion[datHEventDispersion$groupID.y=='LL', ]$Dispersion_norm,breaks=100,main="LF Evoked",xlab="Dispersion Norm.")
hist(datHEventDispersion[datHEventDispersion$groupID.y=='LE', ]$Dispersion_norm,breaks=100,main="LF Spont",xlab="Dispersion Norm.")

## Check NF
hist(datHEventDispersion[datHEventDispersion$groupID.y=='NL', ]$Dispersion_norm,breaks=100,main="NF Evoked",xlab="Dispersion Norm.")
hist(datHEventDispersion[datHEventDispersion$groupID.y=='NE', ]$Dispersion_norm,breaks=100,main="NF Spont",xlab="Dispersion Norm.")

## Check DF
hist(datHEventDispersion[datHEventDispersion$groupID.y=='DL', ]$Dispersion_norm,breaks=100,main="DF Evoked",xlab="Dispersion Norm.")
hist(datHEventDispersion[datHEventDispersion$groupID.y=='DE', ]$Dispersion_norm,breaks=100,main="DF Spont",xlab="Dispersion Norm.")
