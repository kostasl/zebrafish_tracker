...
```{r plot-functions dispersion-clustering,ref.label={'clustering-code-setup'},fig.show='hide', out.width="33%", eval=TRUE, include=FALSE,cache=FALSE,dev='png'}
loadDispersionData()
...
```{r dispersal-RJags-Global-model,ref.label={'clustering-code-setup'},include=TRUE}
...
bQuickTest = FALSE
strOutFilename <- "jagsModelResults_NBMixGroupclustDispersionAndHuntEvents_All2"
...
load(file=paste0(strDataExportDir,'jagsModelResults_NBMixGroupclustDispersionAndHuntEvents_All.RData') )
```
...
results.All <- autoextend.jags(results.All,max.time = "3hr")
save(list=c("results.All","datSubDispersion"),file=paste0(strDataExportDir,strOutFilename,'.RData') )
