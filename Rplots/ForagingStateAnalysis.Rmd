...
load(file=paste0(strDataExportDir,'jagsModelResults_NBMixTestGroupclustDispersionAndHuntEvents_All.RData') )
```
...
if (bQuickTest)
      datSubDispersion   <- sample(datSubDispersion,15000)
...
load(file=paste0(strDataExportDir,strOutFilename,'.RData') )
