...
#### Normalized Dispersion per larva in Spontaneous and Evoked conditions separately
...
hist(rbind(datMaxDispersionPerLarva[datMaxDispersionPerLarva$expID %in% datExpPairs[datExpPairs$groupID.S == 'NE' ,]$expID.S, ]$max_larval_Dispersion,
     ...
     , breaks=nBreaks,main="NF Larvae ", xlab="Dispersion  (max per larva)",xlim=c(0,10),col=colourDataScheme$NF$Evoked)
...
hist(rbind(datMaxDispersionPerLarva[datMaxDispersionPerLarva$expID %in% datExpPairs[datExpPairs$groupID.S == 'LE' ,]$expID.S, ]$max_larval_Dispersion,
     ...
     , breaks=nBreaks,main="LF Larvae ", xlab="Dispersion  (max per larva)",xlim=c(0,10),col=colourDataScheme$LF$Evoked)
...
hist(rbind(datMaxDispersionPerLarva[datMaxDispersionPerLarva$expID %in% datExpPairs[datExpPairs$groupID.S == 'DE' ,]$expID.S, ]$max_larval_Dispersion,
     ...
     , breaks=nBreaks,main="DF Larvae ", xlab="Dispersion  (max per larva)",xlim=c(0,10),col=colourDataScheme$DF$Evoked)
...
Next, I estimated smoothed densities using a gaussian kernel so I can compare  dispersion between spontaneous and evoked conditions `r  BW`
...
```{r,  hunt-event-group-dispersion densities Norm, fig.show="hold", out.width="50%", echo=FALSE, cache=TRUE }
 ## plot est, Densities Compare Spont to Evoked
...
```{r,  hunt-event-dispersion distribution raw split E-S, fig.show="hold", out.width="50%", echo=FALSE, cache=TRUE }
BW = 1
 ylimUp <- 1
...
## Check NF
hist(datHEventDispersion[datHEventDispersion$groupID=='NL' & grepl("Success", as.character(  convertToScoreLabel(datHEventDispersion$huntScore) ) ) , ]$Dispersion_larval_norm,breaks=nBreaks,main="NF Capture Success",xlab="Dispersion ",xlim=c(0,1),col=colourDataScheme$NF$Evoked)

hist(datHEventDispersion[datHEventDispersion$groupID=='NL' & grepl("Fail", as.character(  convertToScoreLabel(datHEventDispersion$huntScore) ) ) , ]$Dispersion_larval_norm,breaks=nBreaks,main="NF Capture Fail",xlab="Dispersion ",xlim=c(0,1),col=colourDataScheme$NF$Spont)

## Check LF Successs/Fail Only
hist(datHEventDispersion[datHEventDispersion$groupID=='LL' & grepl("Success", as.character(  convertToScoreLabel(datHEventDispersion$huntScore) ) ) , ]$Dispersion_larval_norm,breaks=nBreaks,main="LF Capture Success",xlab="Dispersion ",xlim=c(0,1),col=colourDataScheme$LF$Evoked)

hist(datHEventDispersion[datHEventDispersion$groupID=='LL' & grepl("Fail", as.character(  convertToScoreLabel(datHEventDispersion$huntScore) ) ) , ]$Dispersion_larval_norm,breaks=nBreaks,main="LF Capture Fail",xlab="Dispersion ",xlim=c(0,1),col=colourDataScheme$LF$Spont)


## Check DF
hist(datHEventDispersion[datHEventDispersion$groupID=='DL' & grepl("Success", as.character(  convertToScoreLabel(datHEventDispersion$huntScore) ) ) , ]$Dispersion_larval_norm,breaks=nBreaks,main="DF Capture Success",xlab="Dispersion ",xlim=c(0,1),col=colourDataScheme$DF$Evoked)

hist(datHEventDispersion[datHEventDispersion$groupID=='DL' & grepl("Fail", as.character(  convertToScoreLabel(datHEventDispersion$huntScore) ) ) , ]$Dispersion_larval_norm,breaks=nBreaks,main="DF Capture Fail",xlab="Dispersion ",xlim=c(0,1),col=colourDataScheme$DF$Spont)

```

### Dispersion densities per outcome 

```{r,  hunt-event-dispersion per outcome distributions, fig.show="hold", out.width="50%", echo=FALSE, cache=TRUE }
BW = 0.08
ylimUp <- 5
