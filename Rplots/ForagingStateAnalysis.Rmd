...
plotClusterModel <- function(results,vDispersion,groupID)
{
  ...
  hist( pClustcoeff[[3]][,1],xlim=c(0,1), breaks=20,col=c("red"),main=groupID,xlab = "Prob. of cluster membership (pClust)" )
  hist( pClustcoeff[[3]][,2],xlim=c(0,1), breaks=20,col=c("blue"),main=groupID,add=TRUE )
