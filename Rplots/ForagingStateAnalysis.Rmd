...
```{r,  merge hunt events and max_dispersion with dispersion data, fig.show="hold", out.width="50%", echo=FALSE, cache=FALSE,results=FALSE }
...
plotExploreExploitTrajectories <- function(groupID,datGroupExploreTraj,datGroupExploitTraj, datExplorationHuntEvents, datExploitationHuntEvents, datDispersion, datExpPairs, thin=3)
{
  ...
  for (j in 1:nrow(datExpPairs) )
  {
      ...
      plot(idxplot.S/G_APPROXFPS ,datDisp.S[idxplot.S,]$Dispersion,type="l" ,ylim=c(0,10),xlim=c(0,( tail(idxplot.E,1)+tail(idxplot.S,1) )/G_APPROXFPS   ),xlab="(sec)",ylab="Dispersal (mm)" )
      lines((idxplot.E+tail(idxplot.S,1))/G_APPROXFPS ,datDisp.E[idxplot.E,]$Dispersion,type="l",col="red" )
