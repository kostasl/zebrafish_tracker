...
getTrajectoryTurnsAndRuns<- function(TrackLetInfo)  
{
 ...
 #### PROCESS BOUTS ###
  ...
  #     cex=c(0.5,0.5,1.2)[datDomainTrajectory$IndMotionBout+1+(datDomainTrajectory$IndTurnBout > 0)*2] )  
  ...
  {   
      ...
      for (strGroup in names(lBoundedTrackInfo) )
      {
        ...
        #TrackLetInfo <- lBoundedTrackInfo$LL["228-2-73",]
