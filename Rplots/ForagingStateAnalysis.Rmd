...
I will need then to measure the path length between the 2 points that define the  dispersion, and not the path length of the last X sec.

Nevertheless, I may examine if such an *invariance principle holds* (see)[https://iopscience.iop.org/article/10.1209/epl/i2003-00208-x/meta], to see if the mean path length with a dispersion $r$ is only proportional to the Area/Circumfarence ratio for a random walk. 
