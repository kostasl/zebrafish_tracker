...
plotBoundedFreePath <- function(datBoundedTrack,strG,addPlot=FALSE,XLIM=20)  
{
 ...
 {    vBoutCount <- unlist(ldatFreePathsPerDomain[[cD ]][ldatFreePathsPerDomain[[cD ]]$groupID == strG &
                                                   ldatFreePathsPerDomain[[cD ]]$boutCount < 20,]$boutCount)
       hist(vBoutCount,
              breaks=50,main=paste("Bout Count",strG," mu:",mean(vBoutCount)) )
 }
  ...
  for (strG in vGroups)
  {
    ...
    hist(vInterBoutInterval,
              breaks=seq(0,10,0.1), main=paste("Inter-Bout Interval ",strG," mu:",mean(vInterBoutInterval) )  )
  }
...
datTurnsPerDomain <- datBoutsPerDomain
  ...
  for (strG in vGroups)
  {
      ...
      names(runsPerPath[[strG]]) <- ("RunCount")
  }
