...
```{r,  merge hunt events with dispersion data, fig.show="hold", out.width="50%", echo=FALSE, cache=TRUE,results=FALSE }
...
hist(datDispersion[datDispersionM$groupID %in% c('LE','LL'), ]$Dispersion/datDispersion[datDispersionM$groupID %in% c('LE','LL'), ]$max_Dispersion, breaks=100,main="LF S+E ",xlab="Dispersion  (norm per larva)")
hist(datDispersion[datDispersionM$groupID %in% c('NE','NL'), ]$Dispersion/datDispersion[datDispersionM$groupID %in% c('NE','NL'), ]$max_Dispersion, breaks=100,main="NF S+E",xlab="Dispersion  (norm per larva)")
hist(datDispersion[datDispersionM$groupID %in% c('DE','DL'), ]$Dispersion/datDispersion[datDispersionM$groupID %in% c('DE','DL'), ]$max_Dispersion, breaks=100,main="DF S+E",xlab="Dispersion  (norm per larva)")
