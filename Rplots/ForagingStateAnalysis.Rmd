...
```{r,  hunt-event foraging state analysis, fig.show="hold", out.width="50%", echo=FALSE, cache=TRUE,results=FALSE }
...
### Notes from call with Michael McCoullough from Goodhill lab  (14-10-2020 9.30 am)
Goodhill is moving the lab to Washington. 
Michael is staying in Australia, 1yr left. He has imaging data and behavioural data that he wants to explore further. 
Specifically he was looking into analysing the discrete bout movements, using an eigen decomp and clustering, during prey approach.

Here, I explained the concept of biomechanics on the tail, and neural control - discrete - how many control signals to drive the tail motion?
Bheavioural classifications do not provide bridge principles to neural control - The biomechanics howeever will. 
Also he agreed that they find the classifications arbitrary as the behavioural space usually looks continuous (i sent him the Balasz paper).

In this way the maggot community is ahead of the zfish.
So I gave an overview of the larval biomech, work and the mechanical modes, showed him the chaotic maggots commentary, and encouraged him if he wanted to do a piece similar to the ["Capturing the continuous complexity of behaviour in Caenorhabditis elegans"](https://www.nature.com/articles/s41567-020-01036-8)
- I can do the biomechanics and driving modes, and he can provide data on the tail modes.
  
- Overall he concluded he had not thought about these in this way, and will have a think and get back. His initial aim was an MMC of bout types during prey capture.

-The chat also started by saying I do not like how Neuropaper span across data and do not simply nail the evidence to deepen on a single point. 
He said he appreciates the approach, and (maybe) during JC people also asked for imaging, but he agrees that this is something to be chased up later.

-Michael presented my paper to their *lab's Journal Club*, he provided me with some feedback: 

bold approach to statistics in case comprehensive step of analysis
- They really liked the statisical approach
- Hunt Power - What was the intution behind this? - I explained
- How do you tease apart dev. and experience?
  Their recent paper shows capture success goes up through development
   How we do this, did not come out during JC, but now explained the DF-NF-LF ranking reveals it is not nutrition, but also showed supp figure with HPI-size correlation.
- Internal State timer - What is the point of having these -
  KL: You remain in state following up the queus as the come- But abording when later. He liked the idea.
