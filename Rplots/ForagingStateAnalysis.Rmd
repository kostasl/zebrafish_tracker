...
saveRDS(datDispersionM,file=paste0(strDataExportDir,"/dispersionperframe_merged_maxLarvaDispersion_",tsec_timeWindow,"sec.rds") )
message("Saved to:",paste0(strDataExportDir,"/dispersionperframe_merged_maxLarvaDispersion_",tsec_timeWindow,"sec.rds") )


hist(datDispersionM$Dispersion/datDispersionM$max_Dispersion)
...
```{r dispersion histograms normalize per larva, fig.show="hold", out.width="33%", echo=FALSE, results='hide'  }

datExpPairs[datExpPairs$groupID.E == as.character(datDispersion$expID),]$Dispersion_max
