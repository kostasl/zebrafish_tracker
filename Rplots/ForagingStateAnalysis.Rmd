...
For Brownian motion the distribution of step lenghts should be Gaussian, which would show as a rapid decay of step length in log log distribution of displacements in t=1sec. 
