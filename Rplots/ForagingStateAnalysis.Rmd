...
plotExploreExploitTrajectories <- function(groupID,datGroupExploreTraj,datGroupExploitTraj, datExplorationHuntEvents, datExploitationHuntEvents, thin=3)
{
  ...
  for (e in vexpID)
  {
      ...
      if (NROW(datTraj))
      {
        ...
        points(datTraj[idxplot,]$posX,datTraj[idxplot,]$posY,type="p", col="blue", cex=0.1);
      }
      ...
      {      
        idxplot <- seq(1,NROW(datTraj),thin)
        points(datTraj[idxplot,]$posX,datTraj[idxplot,]$posY,type="p",col="red", cex=0.1)
      }
      ...
      points(datSpotHunts$posX, datSpotHunts$posY, col="cyan", cex=1.2, pch=17)
      ## Exploitation
      ...
      points(datSpotHunts$posX, datSpotHunts$posY,col="red", cex=1.2,pch=15)
