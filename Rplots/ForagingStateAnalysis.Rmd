...
### 
plotExploreExploitTrajectories <- function(datGroupExploreTraj,datGroupExploitTraj)
{
...
plotGlobalNormDispersionTrajectories <- function(groupID, datAllFrames, datDispersion, TH_DISP = 0.2)
{
  ...
  ## Call Plot Function
  plotExploreExploitTrajectories(datGroupExploreTraj,datGroupExploitTraj)
...
hist(datDispersion$Dispersion/AllRange[2],breaks=100,main="(All groups): Dispersion  globally normalized",xlab="Dispersion (norm)")
...
For completness, the following dispersions have been normalized to maximum trajectory length found across all experiments:
- Globally normalized)
...
```{r,  global_norm-trajectories-LL, fig.show="hold", out.width="50%", echo=FALSE, results='hide' }
...
```{r, global_norm-trajectories-NL, fig.show="hold", out.width="50%", echo=FALSE, results='hide'}
...
```{r, global_norm-trajectories-DL, fig.show="hold", out.width="50%", echo=FALSE, results='hide'}
...
```{r,  global_norm-trajectories-LE, fig.show="hold", out.width="50%", echo=FALSE, results='hide' }
...
```{r, global_norm-trajectories-NE, fig.show="hold", out.width="50%", echo=FALSE, results='hide'}
...
```{r, global_norm-trajectories-DE, fig.show="hold", out.width="50%", echo=FALSE, results='hide'}
...
#### LF - Evoked Trajectories
```{r,  exp_norm-trajectories-LL, fig.show="hold", out.width="50%", echo=FALSE, results='hide' }
...
#### NF - Evoked Trajectories 
```{r, exp_norm-trajectories-NL, fig.show="hold", out.width="50%", echo=FALSE, results='hide'}
...
#### DF - Evoked Trajectories 
```{r, exp_norm-trajectories-DL, fig.show="hold", out.width="50%", echo=FALSE, results='hide'}
...
#### Spontaneous conditions
### LF - Spontaneous Trajectories
```{r,  exp_norm-trajectories-LE, fig.show="hold", out.width="50%", echo=FALSE, results='hide' }
...
#### NF - Spontaneous Trajectories 
```{r, exp_norm-trajectories-NE, fig.show="hold", out.width="50%", echo=FALSE, results='hide'}
...
#### DF - Spontaneous Trajectories 
```{r, exp_norm-trajectories-DE, fig.show="hold", out.width="50%", echo=FALSE, results='hide'}
