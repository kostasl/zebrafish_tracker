...
mergeMaxLarvalDispersionPerLarvaOntoDispersion <- function(datDispersion,datExpPairs)
{
  ...
  datDispersionM$Dispersion_larval_norm <- NA 
  datDispersionM$Dispersion_larval_norm <- datDispersionM$Dispersion / datDispersionM$max_larval_Dispersion
...
hist(datDispersion$Dispersion/datDispersion$max_Dispersion,breaks=100,main="(All groups): Dispersion normalized per larva",xlab="Dispersion (larva norm)")
...
hist(datExpPairs[datExpPairs$groupID %in% c('LE'), ]$max_larval_Dispersion, breaks=100,main="LF Spont ", xlab="Dispersion  (max per larva)")
hist(datDispersion[datDispersion$groupID %in% c('LL'), ]$max_larval_Dispersion, breaks=100,main="LF Evoked ",xlab="Dispersion  (nmax per larva)")

hist(datDispersion[datDispersion$groupID %in% c('NE'), ]$max_larval_Dispersion, breaks=100,main="NF Spont ", xlab="Dispersion  (max per larva)")
hist(datDispersion[datDispersion$groupID %in% c('NL'), ]$max_larval_Dispersion, breaks=100,main="NF Evoked ",xlab="Dispersion  (max per larva)")

hist(datDispersion[datDispersion$groupID %in% c('DE'), ]$max_larval_Dispersion, breaks=100,main="DF Spont ", xlab="Dispersion  (max per larva)")
hist(datDispersion[datDispersion$groupID %in% c('DL'), ]$max_larval_Dispersion, breaks=100,main="DF Evoked ",xlab="Dispersion  (max per larva)")
