...
## Trajectory Lengths Distributions 
...
Lower ratios are indicative of turtuous paths of low dispersion, ie where the larva moves but is generally constrained to the same region.
