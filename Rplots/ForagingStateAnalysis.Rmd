...
```{r clustering-code-setup,eval=TRUE}
...
makeDispersionDataInferenceSet <- function(bQuickTest = FALSE,nsamp=3000)
{
  #nsubsample <- 10000 
...
##Subsample The Dispersion Data into 0.5 sec bins - But Add the hunt Event Frames
datSubDispersion <- makeDispersionDataInferenceSet(bQuickTest)
