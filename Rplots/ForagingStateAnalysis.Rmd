...
saveRDS(lMSDStat,paste0(strDataExportDir,"MSDPerPathLengthSummaryResults.rds"))
  ...
  ##Combined
   ...
   plot(as.vector(lvmeanPathLengthPerMSD[[strG]]),col=colourDataScheme[[strG]],pch=pointTypeScheme[[strG]],type="b")
   xtick<-seq(1,NCOL(lvmeanPathLengthPerMSD[[strG]]) )
   axis(side=1, at=xtick, labels = FALSE)
    text(x=xtick,  par("usr")[3], 
     labels = colnames(lvmeanPathLengthPerMSD[[strG]]), srt = 45, pos = 1, xpd = TRUE)

   strG <- "NE"
   lvmeanPathLengthPerMSD[[strG]] <- as.matrix (do.call(rbind, lMSDStat[[strG]]$muMSDPerT) )
   points(as.vector(lvmeanPathLengthPerMSD[[strG]]),col=colourDataScheme[[strG]],pch=pointTypeScheme[[strG]],type="b")
