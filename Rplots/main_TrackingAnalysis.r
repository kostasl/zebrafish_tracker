...
pairedPalette["alpha",1:6] <- 220 ##Opacity
...
colourR <- c(rgb(0.9,0.01,0.01,0.4),rgb(0.01,0.7,0.01,0.4),rgb(0.01,0.01,0.9,0.4),rgb(0.1,0.1,0.1,0.4)) ##Region (Transparency)
