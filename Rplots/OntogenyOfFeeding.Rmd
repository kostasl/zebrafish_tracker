...
for (a in vAge)
{
  datDispersion_SummaryAge <- datDispersion_Summary10[datDispersion_Summary10$age == a,]
  # Lower to higher
  ...
  boxplot(datDispersion_SummaryAge$x ~ medians, las = 2, xlab = "", 
          ylab = "",main=paste(a,"dpf tw:",datDispersion.Interval,"sec"),ylim=c(5,20))
}
#boxplot((groupID,  age) ~ x ,data=datDispersion_Summary)

loadDispersionData_norm(5)
datDispersion_Summary5 <- aggregate(datDispersion$Dispersion,by=list(expID=datDispersion$expID, age=datDispersion$age,groupID=datDispersion$groupID,datDispersion$testCond),mean,na.rm=T)
