...
datHuntEvents <- readRDS(file=paste(strDatDir,"/HB_allHuntEvents.rds",sep="" ))
...
datExp8 <- datDispersion[datDispersion$age == 7,]
datExp8NF0 <- datExp8[datExp8$groupID == "NF0" & datExp8$testCond == "LE",]
datExp8LF1 <- datExp8[datExp8$groupID == "LF1" & datExp8$testCond == "LE",]
datExp8LF2 <- datExp8[datExp8$groupID == "LF2" & datExp8$testCond == "LE",]
datExp8LF3 <- datExp8[datExp8$groupID == "LF3" & datExp8$testCond == "LE",]

mean(datExp8NF0$Dispersion,na.rm=T)
mean(datExp8LF1$Dispersion,na.rm=T)
mean(datExp8LF2$Dispersion,na.rm=T)
mean(datExp8LF3$Dispersion,na.rm=T)
```
