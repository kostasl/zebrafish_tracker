...
{
  print(i)  
  datLarvalAllFrames <- filtereddatAllFrames[filtereddatAllFrames$larvaID == i,]
  ...
  bw <- bandwidth.nrd(datLarvalAllFrames$LEyeAngle)
  ...
  ## Eye Density Plot for all events from This Larva ##
...
strDensityplotFileName <- paste("plots/binDensity/EyeAngleDensity-BINSet-",strCond,".pdf",collapse=NULL);
pdf(strDensityplotFileName,width=8,height=8)
